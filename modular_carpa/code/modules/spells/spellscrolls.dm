/obj/item/book/granter/spell/spells5e/
	...
	remarks = list("Fascinante!", "Es eso asi..?", "Como esto?", "De verdad ahora...", "Hay un poco de tonteria en esta seccion...")
	sellprice = 30
...
/obj/item/book/granter/spell/spells5e/onlearned(mob/living/carbon/user)
	...
	if(oneuse == TRUE)
		...
		icon_state = "scroll"
		user.visible_message(span_warning("[src] le han arrancado la tinta magica del pergamino!"))
