...
/obj/effect/temp_visual/trap
	...
	light_range = 2
	duration = 7
	layer = MASSIVE_OBJ_LAYER   //esto no entendi pero aparenteme estaba bug porque algun pendejo lo movio antes y jodia esto por lo que lo cambiaron al modificar unsa variables hace 2 actualziaciones en fin idk
